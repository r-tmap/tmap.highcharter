...
#' @export
tmapHCCompPrepare.tm_legend_standard_portrait = function(comp, o) {
	tmapHC_legend_comp(comp, o)
}


#' @export
tmapHCCompHeight.tm_legend_standard_portrait = function(comp, o) {
	comp
}
...
#' @export
tmapHCCompWidth.tm_legend_standard_portrait = function(comp, o) {
	comp
}


#' @export
tmapHCCompPrepare.tm_legend_standard_landscape = function(comp, o) {
	tmapHC_legend_comp(comp, o)
}

#' @export
tmapHCCompHeight.tm_legend_standard_landscape = function(comp, o) {
	comp
}
...
#' @export
tmapHCCompWidth.tm_legend_standard_landscape = function(comp, o) {
	comp
}

tmapHC_legend_comp = function(comp, o) {
	within(comp, {
