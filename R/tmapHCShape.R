...
#' @name tmapHCShape
#' @rdname tmapHC
tmapHCShape = function(bbx, facet_row, facet_col, facet_page, o) {
	...
	deck = hc::hc(zoom = zoom, latitude = ll[2], longitude = ll[1], pitch = o$pitch) 
...
#' @name tmapHCOverlay
#' @rdname tmapHC
tmapHCOverlay = function(bbx, facet_row, facet_col, facet_page, o) {
	NULL	
}
