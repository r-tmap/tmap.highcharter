...
#' @name tmapHCPolygons
#' @rdname tmapHC
tmapHCPolygons = function(shpTM, dt, pdt, popup.format, hdt, idt, gp, bbx, facet_row, facet_col, facet_page, id, pane, group, o, ...) {
	...
	deck |> hc::add_geojson_layer(data = shp2,
									  getFillColor = hc::JS("object => object.fill"),
									  getLineColor = hc::JS("object => object.col"),
									  getLineWidth = hc::JS("object => object.lwd"),
...
#' @name tmapHCLines
#' @rdname tmapHC
tmapHCLines = function(shpTM, dt, pdt, popup.format, hdt, idt, gp, bbx, facet_row, facet_col, facet_page, id, pane, group, o, ...) {
	deck = get_deck(facet_row, facet_col, facet_page)
...
tmapHCLines = function(shpTM, dt, pdt, popup.format, hdt, idt, gp, bbx, facet_row, facet_col, facet_page, id, pane, group, o) {
	...
	# gp = rescale_gp(gp, o$scale_down)
	# 
	# opt = HC::pathOptions(interactive = TRUE, pane = pane)
	# 
	# if (o$use.WebGL) {
	...
	# } else {
	# 	lf %>% 
	# 		HC::addPolylines(data = shp, layerId = idt, label = hdt, color = gp$col, opacity = gp$col_alpha, weight = gp$lwd, group = group, options = opt, dashArray = lty2dash(gp$lty), popup = popups) %>% 
	# 		assign_lf(facet_row, facet_col, facet_page)
	# 	
	# }
	NULL	
...
#' @name tmapHCSymbols
#' @rdname tmapHC
tmapHCSymbols = function(shpTM, dt, pdt, popup.format, hdt, idt, gp, bbx, facet_row, facet_col, facet_page, id, pane, group, o, ...) {
	# lf = get_lf(facet_row, facet_col, facet_page)
	# 
	# rc_text = frc(facet_row, facet_col)
	# 
	...
	# 	}
	# 
	# 	lf %>% HC::addMarkers(lng = coords[, 1], lat = coords[, 2], 
...
#' @name tmapHCRaster
#' @rdname tmapHC
tmapHCRaster = function(shpTM, dt, gp, pdt, popup.format, hdt, idt, bbx, facet_row, facet_col, facet_page, id, pane, group, o, ...) {
	# 
	# rc_text = frc(facet_row, facet_col)
	# 
	# 
	...
	# 	
	# 	gp$lty = "solid"
	# 	tmapHCPolygons(shpTM, dt, pdt, popup.format = NULL, hdt = NULL, idt = NULL, gp, bbx, facet_row, facet_col, facet_page, id, pane, group, o)
...
#' @name tmapHCText
#' @rdname tmapHC
tmapHCText = function(shpTM, dt, gp, bbx, facet_row, facet_col, facet_page, id, pane, group, o, ...) {
	# args = list(...)
	# 
	# lf = get_lf(facet_row, facet_col, facet_page)
	# 
	...
	# 	clustering = HC::markerClusterOptions()	
	# }
	# 
	# 
	# 
